...
PY = "/Users/jkitchin/Dropbox/uv/.venv/bin/python"
WORKTREE_PY = "/Users/jkitchin/projects/discopt/.claude/worktrees/agent-a6795dbd834ccbff8/python"
...
ARMS = {
    ...
    # The prepared default-ON package (this PR's final commit): all three flags
    # composed - the configuration users would actually get. The pairwise arms
    # above are the graduation evidence; this arm checks the triple composition.
    "triple": {
