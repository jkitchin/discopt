...
| R1.2 univariate cutover | blocked on R1.1 | includes box-aware dominance dispatch; nvs09 cert measured here (see R0.5 watch item — may need CI runner) |
