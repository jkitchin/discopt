...
perf/robustness); the **M4–M8** modeling P1/P2 items (no RESOLVED marker in
`modeling-module-review.md`); the **P2/P3 remainder** across modules. (The
**L2/L3/L4/L7** latex tail is now ✅ — PR `fix-latex-tail-l2-l3-l4-l7`, #413.)
