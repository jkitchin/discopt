...
`docs/dev/nvs05-decline-taint-2026-07-16.md`. Same flag, still default OFF;
with the extension nvs05 flag-ON is no longer byte-identical (it *certifies*:
`optimal`, bound 5.47057).
