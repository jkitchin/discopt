...
Promotes the box-local convexity certificate (``discopt._relax.convexity``)
...
class ConvexReformPass:
    ...
    (`discopt._relax.convexity.certificate.certify_convex`) consumes the
    ...
    closure, e.g.::
        ...
        from discopt._relax.presolve import run_orchestrated_presolve
