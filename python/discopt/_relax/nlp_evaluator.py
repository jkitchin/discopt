...
from discopt._hessian_cost_model import (
    _DENSE_OBJ_HESS_CHEAP_NNZ as _DENSE_OBJ_HESS_CHEAP_NNZ,
)
from discopt._hessian_cost_model import (
    _DENSE_OBJ_HESS_REF_NNZ as _DENSE_OBJ_HESS_REF_NNZ,
)
from discopt._hessian_cost_model import (
    _HESSIAN_COMPILE_DENSE_S as _HESSIAN_COMPILE_DENSE_S,
)
from discopt._hessian_cost_model import (
    _HESSIAN_COMPILE_SPARSE_FLOOR_S as _HESSIAN_COMPILE_SPARSE_FLOOR_S,
)
from discopt._hessian_cost_model import (
    estimate_dense_obj_hessian_compile_s as estimate_dense_obj_hessian_compile_s,
)
from discopt._hessian_cost_model import (
    estimate_hessian_compile_s as estimate_hessian_compile_s,
)
...
# The Hessian compile-cost model lives in the JAX-free
# ``discopt._hessian_cost_model``, re-exported here for callers that import it
# from this module. It moved because ``solver`` consults it on every solve and
# importing it from here dragged the entire JAX stack in (#75).
...
class NLPEvaluator:
    ...
    def _detect_sparsity_traced(self):
        ...
        from discopt._relax.sparsity import SparsityPattern, detect_sparsity_dag
    ...
    def evaluate_hessian_values(
        ...
        Hessian-vector products (see :mod:`discopt._relax.sparse_hessian`),
