...
discopt-distinctive. ``_relax/gdp_reformulate.py`` already supports three
...
def recommend_method(
    ...
    *,
    ...
    """
    from discopt._relax.gdp_reformulate import _bound_expression, _collect_variables, _is_linear
