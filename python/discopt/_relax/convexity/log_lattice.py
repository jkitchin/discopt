...
lattice in :mod:`discopt._relax.convexity.lattice`, propagated through the
*same* :class:`~discopt.modeling.core.Expression` DAG. Where the x-space
walker (:mod:`discopt._relax.convexity.rules`) answers "is this expression
...
class LogCurvature(Enum):
    ...
    Deliberately distinct from :class:`discopt._relax.convexity.Curvature`;
...
def classify_log_curvature(
    ...
    :func:`discopt._relax.convexity.classify_expr`; leaf positivity is read
