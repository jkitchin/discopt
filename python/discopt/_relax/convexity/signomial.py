...
* :func:`is_signomial` — the *canonicaliser*. Parse an :class:`Expression` into
  ...
  the posynomial recogniser (:mod:`discopt._relax.convexity.posynomial`); the one
...
* :func:`signomial_dc_terms` — bridge the canonical form to the log-domain
  ...
  envelope in :mod:`discopt._relax.symbolic.signed_signomial`.
...
class SignomialForm:
    ...
    :class:`~discopt._relax.convexity.posynomial.PosynomialForm`.
    """
...
def signomial_dc_terms(
    ...
    :func:`discopt._relax.symbolic.signed_signomial.signed_signomial_dc_envelope`:
