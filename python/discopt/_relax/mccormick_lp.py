...
:mod:`discopt._relax.mccormick_nlp`, it returns a globally optimal value of
...
from discopt._relax.term_classifier import NonlinearTerms, classify_nonlinear_terms
...
class MccormickLPRelaxer:
    ...
    def set_integer_ratio_partitioner(self, partitioner) -> None:
        """Attach an :class:`~discopt._relax.integer_ratio.IntegerRatioPartitioner`.
