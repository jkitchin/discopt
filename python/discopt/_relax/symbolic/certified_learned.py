...
(:mod:`discopt._relax.learned_relaxations`): a pair of Input Convex Neural Networks
...
symbolic engine (:func:`discopt._relax.symbolic.verify_envelope`).
...
.. note::
   ...
   outward-rounded interval arithmetic in :mod:`discopt._relax.convexity.interval`
...
from discopt._relax.symbolic.verification import (
    VerificationReport,
    verify_envelope,
)
...
def raw_learned_relax_fn(learned) -> Callable:
    ...
    Args:
        learned: A ``discopt._relax.learned_relaxations.LearnedRelaxation``.
