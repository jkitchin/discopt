...
the engine (:func:`discopt._relax.symbolic.verify_envelope`).
...
from discopt._relax.symbolic.domains import chemeng, gas, power
from discopt._relax.symbolic.verification import VerificationReport, verify_envelope
