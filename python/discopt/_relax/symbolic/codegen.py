...
throughout :mod:`discopt._relax.mccormick`::
...
delegates the convex/concave assembly to :mod:`discopt._relax.symbolic.runtime`,
...
from discopt._relax.symbolic.envelope_deriver import (
    Curvature,
    EnvelopeResult,
    Tangent,
)
