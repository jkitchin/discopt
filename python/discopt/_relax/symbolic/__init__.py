...
parts of this package (the pure-JAX :mod:`~discopt._relax.symbolic.runtime`
assembly, the hand-written :mod:`~discopt._relax.symbolic.domains` packs, the
numeric :mod:`~discopt._relax.symbolic.patterns`, etc.).
...
if TYPE_CHECKING:  # static type-checkers / IDEs see the real symbols
    from discopt._relax.symbolic.codegen import lambdify_envelope  # noqa: F401
    from discopt._relax.symbolic.envelope_deriver import (  # noqa: F401
        Curvature,
        EnvelopeResult,
        derive_envelope,
    )
    from discopt._relax.symbolic.verification import (  # noqa: F401
        VerificationReport,
        verify_envelope,
    )
