...
- `python/discopt/solvers/nlp_ipopt.py`, `qp_pounce.py`, `lp_simplex.py` — NLP/QP/LP backends (the QP path is POUNCE-only and HiGHS-free, #359; the default per-node LP engine is the in-house Rust simplex).
